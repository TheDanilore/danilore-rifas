        ...
        <form @submit.prevent="handleLogin" class="auth-form">
          ...
          <div class="tab-content" :class="{ active: currentTab === 'email' }">
            <div class="input-group">
              ...
              <input type="email" class="form-input" placeholder="tu@email.com" v-model="form.email"
                :required="currentTab === 'email'" autocomplete="email">
            </div>
          </div>
          ...
          <div class="tab-content" :class="{ active: currentTab === 'phone' }">
            <div class="input-group">
              ...
              <input type="tel" class="form-input phone-input" placeholder="999 888 777" v-model="form.phone"
                :required="currentTab === 'phone'" autocomplete="tel">
            </div>
          </div>
          ...
          <div class="input-group">
            ...
            <input :type="showPassword ? 'text' : 'password'" class="form-input" placeholder="Tu contraseña"
...
export default {
  ...
  setup() {
    ...
    const fullPhoneNumber = computed(() => {
      if (form.phone && form.pais) {
        return formatPhoneWithCountry(form.phone, form.pais)
      }
      return form.phone
    })
    ...
    const handleLogin = async () => {
      ...
      try {
        ...
        if (currentTab.value === 'email') {
          ...
          loginData.identifier = form.email
        } else {
          if (!form.phone) {
        ...
        if (error.message.includes('Credenciales incorrectas')) {
          errorMessage.value = currentTab.value === 'email'
