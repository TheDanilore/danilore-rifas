    ...
    public function run(): void
    {
        ...
        if ($rifaIphone) {
            ...
            DB::table('premios')->updateOrInsert(
                ['rifa_id' => $rifaIphone->id, 'codigo' => 'p1'],
                [
            ...
            DB::table('premios')->updateOrInsert(
                ['rifa_id' => $rifaIphone->id, 'codigo' => 'p2'],
                [
            ...
            DB::table('premios')->updateOrInsert(
                ['rifa_id' => $rifaIphone->id, 'codigo' => 'p3'],
                [
        ...
        if ($rifaMacbook) {
            ...
            DB::table('premios')->updateOrInsert(
                ['rifa_id' => $rifaMacbook->id, 'codigo' => 'p1'],
                [
            ...
            // Obtener el ID del primer premio para referencia
            $premioMac1 = DB::table('premios')->where('rifa_id', $rifaMacbook->id)->where('codigo', 'p1')->first();

            // Premio 2: Studio Display (MacBook)
            DB::table('premios')->updateOrInsert(
                ['rifa_id' => $rifaMacbook->id, 'codigo' => 'p2'],
                [
            ...
            // Obtener el ID del segundo premio para referencia
            $premioMac2 = DB::table('premios')->where('rifa_id', $rifaMacbook->id)->where('codigo', 'p2')->first();
