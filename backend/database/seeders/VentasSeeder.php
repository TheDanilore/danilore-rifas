        ...
        for ($i = 1; $i <= 500; $i++) {
            ...
            DB::table('ventas')->updateOrInsert(
                ...
                [
                    ...
                    'estado' => 'confirmado',
                    'metodo_pago' => collect(['yape', 'plin', 'transferencia'])->random(),
            ...
            DB::table('boletos')->updateOrInsert(
                ...
                [
                    ...
                    'numero' => (string)$i,
                    'codigo_verificacion' => 'VER' . strtoupper(substr(md5($i . $usuario->id), 0, 8)),
        ...
        for ($i = 1; $i <= 50; $i++) {
            ...
            DB::table('boletos')->updateOrInsert(
                ...
                [
                    ...
                    'venta_id' => DB::table('ventas')->where('codigo_venta', $codigoVenta)->first()->id,
                    'numero' => $numeroBoleto,
                    'codigo_verificacion' => 'TES' . strtoupper(substr(md5($i . $usuario->id), 0, 8)),
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            DB::table('boletos')->updateOrInsert(
                ...
                [
                    ...
                    'venta_id' => DB::table('ventas')->where('codigo_venta', $codigoVenta)->first()->id,
                    'numero' => $numeroBoleto,
                    'codigo_verificacion' => 'PEN' . strtoupper(substr(md5($i . $usuario->id), 0, 8)),
                    'precio_pagado' => $rifaIphone->precio_boleto,
                    'estado' => 'reservado',
                    'fecha_reserva' => $fechaVenta,
                    'fecha_expiracion_reserva' => $fechaVenta->copy()->addMinutes(15),
