...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->string('avatar')->nullable()->after('verificado'); // URL del avatar

            // Preferencias de notificaciones
            $table->json('preferencias_notificacion')->nullable()->after('avatar'); // JSON más flexible

            // Términos y condiciones
            $table->boolean('acepta_terminos')->default(false)->after('preferencias_notificacion'); // Acepta términos y condiciones
            $table->timestamp('fecha_aceptacion_terminos')->nullable()->after('acepta_terminos'); // Fecha cuando aceptó términos
            $table->boolean('acepta_marketing')->default(false)->after('fecha_aceptacion_terminos'); // Acepta recibir promociones
            $table->timestamp('fecha_aceptacion_marketing')->nullable()->after('acepta_marketing'); // Fecha cuando aceptó marketing
